package com.cicadalabs.sidebardrawernav;
...
public class SidebarDrawerLayout extends DrawerLayout {
    private static final String TAG = SidebarDrawerLayout.class.getSimpleName();
    ...
    public SidebarDrawerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);

    }

    public SidebarDrawerLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        addDrawerListener(new DrawerListener() {
            ...
            public void onDrawerSlide(View drawerView, float slideOffset) {
                SidebarDrawerLayout.this.drawerView = drawerView;
...
//    }
    ...
    public void setBackgroundImage(Drawable backgroundResource){
        frameLayout.setBackgroundDrawable(backgroundResource);
    }
